...
export const EXTENSION_LABEL: Record<Extension, string> = {
  base: "Le jeu de base",
  "nouvelle-lune": "Nouvelle Lune",
  personnages: "Personnages",
  village: "Le Village",
  pacte: "Nouvelle édition / Le Pacte",
  bonus: "Rôles bonus & maison",
};
...
export const ROLES: Role[] = [
  ...
  {
    id: "voleur-v2",
    name: "Voleur d'Identité (V2)",
    camp: "special",
    extension: "bonus",
    max: 1,
    wakeOrder: 2,
    emoji: "🎭",
    short: "Vole la carte d'un joueur vivant.",
    description:
      "Variante avancée du Voleur : la première nuit, il désigne un joueur et échange définitivement sa carte avec la sienne. Les deux joueurs sont informés au matin de leur nouveau rôle par le Maître du Jeu.",
  },
  {
    id: "medium",
    name: "Le Médium",
    ...
    max: 1,
    emoji: "🕯️",
    short: "Apprend le rôle du premier mort.",
    description:
      "Le Médium découvre en secret la carte du premier joueur éliminé de la partie, puis, chaque nuit paire, celle d'un autre mort.",
  },
  {
    id: "garde-champetre",
